 ...
 */
router.get('/', authenticate(), authorizeRoles(['admin']), (req, res) => reservationController.getAllReservations(req, res));

/**
 * @route GET /api/reservations/user/:email
...
router.get('/user/:email', authenticate(), (req, res) => reservationController.getReservationsByUserEmail(req, res));
 ...
 */
router.get('/date/:date', authenticate(), authorizeRoles(['admin', 'teacher']), (req, res) => reservationController.getReservationsByDate(req, res));
